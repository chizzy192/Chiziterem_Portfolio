...
const ContactMe = () => {
  ...
  return (
    <section id="contact" className='h-auto md:min-h-screen px-5 sm:px-20 lg:px-10 xl:px-35 w-full relative flex justify-center items-center text-2xl text-start font-inter flex-col pb-40 md:mb-30 xl:pb-20'>
      ...
      <div className="bg-(--background) w-full h-auto lg:w-[70%] lg:h-105 rounded-2xl outline-2 outline-(--accent) flex max-lg:flex-col p-3 sm:p-5 lg:p-4 xl:p-8 justify-between items-center gap-6 sm:gap-4 xl:gap-10 shadow-lg">
            ...
            <div className="w-full h-full flex flex-col gap-5 justify-between ">
                <div className="relative inline-block w-fit">
                    ...
                    <div className="absolute left-0 bottom-0 w-full h-1 bg-transparent">
                        <div className="h-full bg-(--accent-font) rounded-full  mt-3"></div>
                    </div>
                </div>
        ...
        <div className="contact-left  rounded-2xl w-full h-full">
            <div className="rounded-2xl w-full h-full gap-7 flex flex-col justify-between">
                <div className="relative inline-block w-fit">
                    <div className="font-bold">
                        Send a Message
                    </div>
